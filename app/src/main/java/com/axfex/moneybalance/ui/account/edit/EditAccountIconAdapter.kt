...
class EditAccountIconAdapter(val viewModel: EditAccountViewModel) :
    ListAdapter<Icon, EditAccountIconAdapter.ViewHolder>(DrawableDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.fragment_edit_account_icon_item, parent, false)
    ...
    inner class ViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        fun bind(icon: Icon, position: Int) {
            ...
            val image = view.findViewById<ImageView>(R.id.accountIconPreview)
            val name = view.findViewById<TextView>(R.id.accountIconName)
